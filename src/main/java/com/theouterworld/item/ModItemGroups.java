    ...
    public static final ItemGroup OUTER_WORLD_GROUP = Registry.register(Registries.ITEM_GROUP,
        ...
        FabricItemGroup.builder()
            ...
            .entries((displayContext, entries) -> {
                ...
                entries.add(ModBlocks.WAXED_IRON);
                ...
                entries.add(ModBlocks.WAXED_IRON_CHAIN);
                ...
                entries.add(ModBlocks.WAXED_IRON_DOOR);
                ...
                entries.add(ModBlocks.WAXED_IRON_TRAPDOOR);
                ...
                entries.add(ModBlocks.EXPOSED_IRON_BARS);
                entries.add(ModBlocks.WEATHERED_IRON_BARS);
                entries.add(ModBlocks.OXIDIZED_IRON_BARS);
                entries.add(ModBlocks.WAXED_EXPOSED_IRON_BARS);
                entries.add(ModBlocks.WAXED_WEATHERED_IRON_BARS);
                entries.add(ModBlocks.WAXED_OXIDIZED_IRON_BARS);
                entries.add(ModBlocks.WAXED_IRON_BARS);
                ...
                entries.add(ModBlocks.OXIDIZED_CUT_IRON);
                entries.add(ModBlocks.WAXED_CUT_IRON);
                entries.add(ModBlocks.WAXED_EXPOSED_CUT_IRON);
                entries.add(ModBlocks.WAXED_WEATHERED_CUT_IRON);
                entries.add(ModBlocks.WAXED_OXIDIZED_CUT_IRON);
                entries.add(ModBlocks.CUT_IRON_SLAB);
                entries.add(ModBlocks.EXPOSED_CUT_IRON_SLAB);
                entries.add(ModBlocks.WEATHERED_CUT_IRON_SLAB);
                entries.add(ModBlocks.OXIDIZED_CUT_IRON_SLAB);
                entries.add(ModBlocks.WAXED_CUT_IRON_SLAB);
                entries.add(ModBlocks.WAXED_EXPOSED_CUT_IRON_SLAB);
                entries.add(ModBlocks.WAXED_WEATHERED_CUT_IRON_SLAB);
                entries.add(ModBlocks.WAXED_OXIDIZED_CUT_IRON_SLAB);
                entries.add(ModBlocks.CUT_IRON_STAIRS);
                entries.add(ModBlocks.EXPOSED_CUT_IRON_STAIRS);
                entries.add(ModBlocks.WEATHERED_CUT_IRON_STAIRS);
                entries.add(ModBlocks.OXIDIZED_CUT_IRON_STAIRS);
                entries.add(ModBlocks.WAXED_CUT_IRON_STAIRS);
