...
/**
 * Non-oxidizable copper door - looks like vanilla copper door but never oxidizes.
 */
public class NonOxidizableCopperDoorBlock extends DoorBlock {
    private final Block vanillaCounterpart;
    
    public NonOxidizableCopperDoorBlock(Block vanillaCounterpart, BlockSetType blockSetType, Settings settings) {
