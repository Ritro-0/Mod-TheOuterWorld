...
public class WaxedCutIronStairsBlock extends StairsBlock {
    private final Block unwaxedVersion;

    public WaxedCutIronStairsBlock(Block unwaxedVersion, BlockState baseBlockState, Settings settings) {
