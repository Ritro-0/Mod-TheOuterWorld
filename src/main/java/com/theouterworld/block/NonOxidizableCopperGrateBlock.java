...
/**
 * Non-oxidizable copper grate - looks like vanilla copper grate but never oxidizes.
 */
public class NonOxidizableCopperGrateBlock extends GrateBlock {
    private final Block vanillaCounterpart;
    
    public NonOxidizableCopperGrateBlock(Block vanillaCounterpart, Settings settings) {
        super(settings);
