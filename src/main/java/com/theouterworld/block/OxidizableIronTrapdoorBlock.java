...
public class OxidizableIronTrapdoorBlock extends TrapdoorBlock implements Oxidizable {
    ...
    public OxidizableIronTrapdoorBlock(Oxidizable.OxidationLevel degradationLevel, Block nextOxidizedBlock, Block previousOxidizedBlock, BlockSetType blockSetType, Settings settings) {
    ...
    protected void tickDegradation(BlockState state, World world, BlockPos pos, Random random) {
        ...
        if (random.nextFloat() < chance) {
            // Copy trapdoor properties to new state
