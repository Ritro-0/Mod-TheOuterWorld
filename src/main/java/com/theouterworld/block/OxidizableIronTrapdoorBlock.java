...
public class OxidizableIronTrapdoorBlock extends TrapdoorBlock implements Oxidizable {
    ...
    public OxidizableIronTrapdoorBlock(Oxidizable.OxidationLevel degradationLevel, BlockSetType blockSetType, Settings settings) {
    ...
    public ItemStack getPickStack(WorldView world, BlockPos pos, BlockState state) {
        ...
        return new ItemStack(net.minecraft.block.Blocks.IRON_TRAPDOOR);
    }
}
