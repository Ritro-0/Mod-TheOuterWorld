...
/**
 * Non-oxidizable copper slab - looks like vanilla copper slab but never oxidizes.
 */
public class NonOxidizableCopperSlabBlock extends SlabBlock {
    private final Block vanillaCounterpart;
    
    public NonOxidizableCopperSlabBlock(Block vanillaCounterpart, Settings settings) {
        super(settings);
