...
public class OxidizableCutIronSlabBlock extends SlabBlock implements Oxidizable {
    private final Oxidizable.OxidationLevel degradationLevel;
    private Block waxedVersion;

    public OxidizableCutIronSlabBlock(Oxidizable.OxidationLevel degradationLevel, Settings settings) {
        super(settings);
