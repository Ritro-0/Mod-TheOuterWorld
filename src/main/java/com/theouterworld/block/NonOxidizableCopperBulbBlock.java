...
/**
 * Non-oxidizable copper bulb - looks like vanilla copper bulb but never oxidizes.
 */
public class NonOxidizableCopperBulbBlock extends BulbBlock {
    private final Block vanillaCounterpart;
    
    public NonOxidizableCopperBulbBlock(Block vanillaCounterpart, Settings settings) {
        super(settings);
