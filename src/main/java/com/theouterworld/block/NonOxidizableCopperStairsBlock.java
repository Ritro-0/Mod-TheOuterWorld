...
/**
 * Non-oxidizable copper stairs - looks like vanilla copper stairs but never oxidizes.
 */
public class NonOxidizableCopperStairsBlock extends StairsBlock {
    private final Block vanillaCounterpart;
    
    public NonOxidizableCopperStairsBlock(Block vanillaCounterpart, BlockState baseBlockState, Settings settings) {
