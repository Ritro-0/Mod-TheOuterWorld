...
/**
 * Non-oxidizable copper bars - looks like vanilla copper bars but never oxidizes.
 */
public class NonOxidizableCopperBarsBlock extends PaneBlock {
    private final Block vanillaCounterpart;
    
    public NonOxidizableCopperBarsBlock(Block vanillaCounterpart, Settings settings) {
        super(settings);
