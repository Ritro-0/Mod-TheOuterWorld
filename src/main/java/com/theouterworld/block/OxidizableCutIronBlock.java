...
public class OxidizableCutIronBlock extends Block implements Oxidizable {
    private final Oxidizable.OxidationLevel degradationLevel;
    private Block waxedVersion;

    public OxidizableCutIronBlock(Oxidizable.OxidationLevel degradationLevel, Settings settings) {
        super(settings);
