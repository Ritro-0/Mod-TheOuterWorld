...
public class OxidizableIronBarsBlock extends PaneBlock implements Oxidizable {
    private final Oxidizable.OxidationLevel degradationLevel;
    private Block waxedVersion;

    public OxidizableIronBarsBlock(Oxidizable.OxidationLevel degradationLevel, Settings settings) {
        super(settings);
